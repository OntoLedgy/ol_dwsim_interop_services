...
def build_session_tools() -> list[types.Tool]:
    ...
    return [
        types.Tool(
            ...
            description="Create a new DWSIM session for flowsheet work.",
        ...
        types.Tool(
            name="close_session",
            title="Close Session",
            description="Close an existing DWSIM session and release resources.",
        ...
        types.Tool(
            name="save_case",
            title="Save Case",
            description="Save the current flowsheet case to an allowed file path.",
        ...
        types.Tool(
            name="load_case",
            title="Load Case",
            description="Load a flowsheet case from an allowed file path into a session.",
