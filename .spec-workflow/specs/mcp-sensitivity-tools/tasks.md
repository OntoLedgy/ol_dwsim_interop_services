...
- [x] 1. Create sensitivity input models
...
- [x] 2. Create optimization input models
...
- [x] 3. Create sensitivity result models
...
- [x] 4. Export models in package __init__.py
...
- [x] 5. Create SensitivityService skeleton
...
- [x] 6. Implement single-variable sensitivity analysis
  - File: `mcp_service/server/dwsim_mcp_server/services/sensitivity_service.py`
...
- [x] 7. Implement parameter sweep (multi-variable)
  - File: `mcp_service/server/dwsim_mcp_server/services/sensitivity_service.py`
...
- [x] 9. Implement progress tracking and cancellation
  - File: `mcp_service/server/dwsim_mcp_server/services/sensitivity_service.py`
...
- [x] 11. Create sensitivity tools module
...
- [x] 12. Implement tool handler dispatch
  - File: `mcp_service/server/dwsim_mcp_server/tools/sensitivity.py`
...
- [x] 13. Register tools in registry
...
- [x] 14. Inject SensitivityService in dependencies
...
- [x] 15. Test sensitivity input models
...
- [x] 16. Test sensitivity tools dispatch
...
- [x] 17. Test SensitivityService logic
...
- [x] 18. Integration test: sensitivity analysis end-to-end
...
- [x] 19. Integration test: optimization end-to-end
...
- [x] 20. Integration test: export functionality
  - File: `mcp_service/server/tests/integration/test_sensitivity_integration.py` (append)
