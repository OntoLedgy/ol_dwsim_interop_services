...
Every running `ol-dwsim-mcp-server` instance exposes the exact source metadata for that deployment: package name, version, commit SHA, source repository URL, and license.
